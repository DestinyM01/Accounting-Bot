...
- <b>Витрати 🛍️:</b> Додавання витрат.
- <b>Видалення останніх️❌:</b> Видалення останніх транзакцій.
...
3️⃣ <i>Натисніть 'Створити родину👩‍❤️‍👨'.</i>
...
<b>MonoBank card:</b> ${process.env.MONO}`,
  ua: `<u>Оберіть зручний спосіб підтримка проєкту:</u>
