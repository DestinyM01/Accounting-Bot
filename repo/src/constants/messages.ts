export const MAIN_MENU = {
  ...
  es: '👋Bienvenido al menú principal, selecciona el elemento deseado⤵️',
};
...
export const ERROR_MESSAGE = {
  ...
  es: '⛔️ Ocurrió un error al ejecutar el comando. Por favor, inténtalo de nuevo más tarde. ⛔️',
};
...
export const SELECT_TRANSACTION_MESSAGE = {
  ...
  es: 'Por favor selecciona la transacción que necesitas:🔽',
};
...
export const ENTER_INCOME_MESSAGE = {
  ...
  es: `Ingresa el nombre del ingreso y el monto separados por un espacio. \n<b><u>Para ingresar múltiples transacciones, sepáralas con una coma.</u></b> \nNota: Usa hasta <b>tres palabras para el nombre de cada transacción, se permiten emojis.</b>\n<u>Ejemplo: "<b>Salario 💼 100000</b>, <b>Bono 🏆 5000"</b></u>`,
};
...
export const ENTER_EXPENSE_MESSAGE = {
  ...
  es: `Ingresa el nombre del gasto y el monto separados por un espacio. \n<b><u>Para ingresar múltiples transacciones, sepáralas con una coma.</u></b> \nNota: Usa hasta <b>tres palabras para el nombre de cada transacción, se permiten emojis.</b>\n<u>Ejemplo: "<b>Alquiler 🏠 2000</b>, <b>Supermercado 🛒 500"</b></u>`,
};
...
export const SELECT_CATEGORY_MESSAGE = {
  ...
  es: 'Selecciona la categoría de la transacción:',
};
...
export const WANT_STATISTICS_MESSAGE = {
  ...
  es: '¿Deseas recibir estadísticas de transacciones? Selecciona un parámetro:',
};
...
export const INVALID_DATA_MESSAGE = {
  ...
  es: 'Por favor ingresa datos válidos.',
};
...
export const INVALID_TRANSACTION_NAME_MESSAGE = {
  ...
  es: 'Por favor especifica una o dos palabras en el campo "Nombre de transacción".',
};
...
export const CREATE_TRANSACTION_MESSAGE = {
  ...
  es: `🔽Tus estadísticas sobre estas transacciones🔽`,
};

export const getBalanceMessage = (balance: number, language: string = 'en', currency: string = 'DOP') => {
  ...
  const messages = {
    ...
    es: `<b>Tu balance: ${balance}${setCurrency} </b>🗃️`,
  };
...
export const DELETE_LAST_MESSAGE = {
  ...
  es: 'Si cometiste un error o simplemente quieres eliminar una transacción, selecciona las transacciones a eliminar🗑️:',
};
...
export const DELETE_LAST_MESSAGE2 = {
  ...
  es: '⛔️No hay transacciones disponibles para eliminar.⛔️:',
};
...
export const PERIOD_E = {
  ...
  es: '⛔️No hay transacciones para este período⛔️',
};
...
export const RESETS_ALL = {
  ...
  es: {
    CONFIRM_RESET: 'Todos tus datos serán eliminados permanentemente. Si estás de acuerdo, escribe `RESET`.',
    RESET_SUCCESSFUL: 'Eliminación exitosa.',
    RESET_CANCELED: 'La eliminación de tus datos ha sido cancelada.',
    ARE_YOU_SURE: '¿Estás seguro? Todos tus datos serán eliminados.',
  },
};
...
export const SELECT_SETTING_MESSAGE = {
  ...
  es: 'Selecciona la configuración:🔽',
};
...
export const SELECT_CURRENCY_MESSAGE = {
  ...
  es: 'Elige la moneda que necesitas:🔽',
};
...
export const DELETE_COMPARE_DATA = {
  ...
  es: 'Datos eliminados exitosamente✅.',
};
...
export const DATA_PERIOD = (startDate: string, endDate: string, language: string) => {
  const message = {
    ...
    es: `Período del ${startDate} al ${endDate}📆\n`,
  };
...
export const ADVANCE_STATISTICS = {
  ...
  es: `Este es el menú de estadísticas avanzadas, aún está en desarrollo⚙️, se añadirá nueva funcionalidad aquí`,
};
...
export const TOP10 = {
  ...
  es: `Este es un gráfico de tus 🔝10 principales transacciones de todos los tiempos`,
};
...
export const SELECT_PERIOD = {
  ...
  es: `Este es tu gráfico para el período seleccionado`,
};
...
export const INFO_MESSAGE = {
  ...
  es: `Este menú de información, información útil aparecerá aquí ℹ️`,
};
...
export const SET_BALANCE = {
  ...
  es: `El balance está establecido en:`,
};
...
export const SET_BALANCE_TEX = {
 ...
 (możesz też dodać znak ➖ i saldo będzie ujemne)🔽🔽🔽`,
  es: `Si necesitas cambiar el balance al que desees, escríbelo a continuación
  (también puedes agregar el signo ➖ y el balance será negativo)🔽🔽🔽`,
};
