 ...
 * ("$1.4T"), and anything that would round to $1000T or more in magnitude
 * just says "over $999T" (positive) or "below -$999T" (negative) — never E
 * notation.
 */
export function calcMoney(n: number, cents = true): string {
  ...
  if (abs >= 999.95e12) return n < 0 ? 'below -$999T' : 'over $999T';
